...
public class TaskRunnerStats implements DataEntity,Serializable{
    ...
    public void setTimeWaitQueue(int timeWaitQueue){
        if (!Objects.equals(this.timeWaitQueue, timeWaitQueue)){
            ...
            this.UPDATED_INFO.append("time_wait_queue:\"" + this.timeWaitQueue+ "\"=>\"" + timeWaitQueue + "\"\r\n");
    ...
    public void setTimeWaitDelay(int timeWaitDelay){
        if (!Objects.equals(this.timeWaitDelay, timeWaitDelay)){
            ...
            this.UPDATED_INFO.append("time_wait_delay:\"" + this.timeWaitDelay+ "\"=>\"" + timeWaitDelay + "\"\r\n");
    ...
    public void setQueueSize(int queueSize){
        if (!Objects.equals(this.queueSize, queueSize)){
            ...
            this.UPDATED_INFO.append("queue_size:\"" + this.queueSize+ "\"=>\"" + queueSize + "\"\r\n");
